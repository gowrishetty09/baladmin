    ...
    <GradientBackground>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        >
          ...
          (booking as any)?.vehicle?.plateNumber ? (
            <>
              <Text
                style={[
                  styles.label,
          ...
          {booking.driver ? (
            <>
              ...
              >
                {booking.driver.name} · {booking.driver.vehicleNumber}
              </Text>
            </>
          ) : (
            <View style={styles.warningRow}>
              ...
              <Text
                style={[styles.value, { color: Colors.warning, marginLeft: 6 }]}
              >
                No driver assigned
              </Text>
            </View>
